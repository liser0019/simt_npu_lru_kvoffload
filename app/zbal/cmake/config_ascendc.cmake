...
elseif (EXISTS ${ASCEND_HOME_PATH}/ascendc_devkit/tikcpp/samples/cmake)
    ...
    message(FATAL_ERROR "app/zbal: ascendc_kernel_cmake does not exist, please check whether the cann package is installed.")
endif ()

include(${ASCENDC_CMAKE_DIR}/ascendc.cmake)

message(STATUS "app/zbal: ASCEND_CANN_PACKAGE_PATH = ${ASCEND_CANN_PACKAGE_PATH}")
message(STATUS "app/zbal: ASCEND_HOME_PATH = ${ASCEND_HOME_PATH}")
